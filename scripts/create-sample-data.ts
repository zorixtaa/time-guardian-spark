...
async function createSampleData() {
  try {
    ...
    const teams = [
      { id: '00000000-0000-0000-0000-000000000001', name: 'Engineering' },
      { id: '00000000-0000-0000-0000-000000000002', name: 'Sales' },
      { id: '00000000-0000-0000-0000-000000000003', name: 'Marketing' },
      { id: '00000000-0000-0000-0000-000000000004', name: 'Support' }
    ]
    ...
    const attendanceRecords = [
      { user_id: 'emp-1', clock_in: new Date(startOfDay.getTime() + 0 * 30 * 60000) }, // 9:00 AM
      { user_id: 'emp-2', clock_in: new Date(startOfDay.getTime() + 1 * 30 * 60000) }, // 9:30 AM
      { user_id: 'emp-3', clock_in: new Date(startOfDay.getTime() + 2 * 30 * 60000) }, // 10:00 AM
      { user_id: 'emp-4', clock_in: new Date(startOfDay.getTime() + 3 * 30 * 60000) }, // 10:30 AM
      { user_id: 'emp-5', clock_in: new Date(startOfDay.getTime() + 4 * 30 * 60000) }, // 11:00 AM
    ]
    ...
    const breakRecords = [
      { user_id: 'emp-1', type: 'coffee', status: 'active' },
      { user_id: 'emp-3', type: 'lunch', status: 'active' }
    ]
